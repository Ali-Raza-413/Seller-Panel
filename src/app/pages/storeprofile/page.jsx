        ...
        <div>
          ...
          <div>
            ...
            <div>
              <button
                type="button"
                className="bg-[#04B78A] text-white text-md px-9 py-2 rounded-xl"
              >
                Verified
              </button>
            </div>
            <button
              ...
              className="bg-black text-white text-md px-4 py-2 rounded-xl mb-4 mt-2"
            >
              Change Logo
            </button>
          </div>
          <form
            onSubmit={handleSubmit}
            className="flex-grow grid grid-cols-12 gap-4 space-y-6"
          >
            <h3 className="col-span-10 text-lg font-semibold">
              Shop infromation
            </h3>
